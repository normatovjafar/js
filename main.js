...
//    alert(jafar)
// }
// add(victus="MARS IT SCHOOL",jafar=(victus.length))
...
// let harflar = ["a" , "b" , "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t",  "u" , "v" , "x" , "y" , "z" ]
// console.log(harflar[8],harflar[0],harflar[4],harflar[0],harflar[16]);
...
// if (userText<18) {
//    alert("siz balog'at yoshida emassiz")
// }
// else{
...
// const text  = prompt("Ismgizni kiriting");
